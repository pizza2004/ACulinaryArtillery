...
namespace ACulinaryArtillery
{
    public class GuiDialogBlockEntityMixingBowl : GuiDialogBlockEntity
    {
        ...
        public GuiDialogBlockEntityMixingBowl(string DialogTitle, InventoryBase Inventory, BlockPos BlockEntityPosition, ICoreClientAPI capi) : base(DialogTitle, Inventory, BlockEntityPosition, capi)
        {
        ...
        void SetupDialog()
        {
            ...
            SingleComposer = capi.Gui
                ...
                .BeginChildElements(bgBounds)
                    ...
                    .AddDynamicText(globalOutputText ?? "", CairoFont.WhiteDetailText().WithOrientation(EnumTextOrientation.Left), ElementBounds.Fixed(0, 30, 210, 45), "outputText")
                    .AddItemSlotGrid(Inventory, SendInvPacket, 1, [0], inputSlotBounds, "inputSlot")
                    .AddItemSlotGrid(Inventory, SendInvPacket, 6, [2, 3, 4, 5, 6, 7], ingredSlotBounds, "ingredSlots")
                    .AddItemSlotGrid(Inventory, SendInvPacket, 1, [1], outputSlotBounds, "outputslot")
                .EndChildElements()
                .Compose()
            ;
        ...
        private void OnBgDraw(Context ctx, ImageSurface surface, ElementBounds currentBounds)
        {
            ...
            gradient.AddColorStop(0, new(0, 0.4, 0, 1));
            gradient.AddColorStop(1, new(0.2, 0.6, 0.2, 1));
